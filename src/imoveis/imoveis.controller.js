...
var ImoveisController = /** @class */ (function () {
    function ImoveisController(imoveisService) {
        this.imoveisService = imoveisService;
    }
    ImoveisController.prototype.importacao = function () {
        return this.imoveisService.importacao();
    };
    __decorate([
        (0, common_1.Get)('importacao')
    ], ImoveisController.prototype, "importacao");
